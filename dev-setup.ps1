...
$sourceDir = "d:\GIT\AutoAntigravity"
$version = (Get-Content "$sourceDir\package.json" | ConvertFrom-Json).version
$targetDir = "$extensionsDir\trollgames.auto-antigravity-$version"
...
# 기존 설치된 확장 폴더 백업/제거
$existingDirs = Get-ChildItem $extensionsDir -Directory -Filter "trollgames.auto-antigravity-*"
