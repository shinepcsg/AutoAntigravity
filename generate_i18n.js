...
const i18n = {
  "en": {
    ...
    "cfg.enableParallel": "Enable parallel execution for tasks tagged with #parallel",
  ...
  "ko": {
    ...
    "cfg.enableParallel": "#parallel 태그 작업의 병렬 실행 허용",
  ...
  "ja": {
    ...
    "cfg.enableParallel": "#parallel タグ付きタスクの並列実行を有効にする",
  ...
  "zh-cn": {
    ...
    "cfg.enableParallel": "启用标记为 #parallel 的任务并行执行",
  ...
  "zh-tw": {
    ...
    "cfg.enableParallel": "啟用標有 #parallel 的任務並行執行",
  ...
  "es": {
    ...
    "cfg.enableParallel": "Permitir ejecución en paralelo para tareas con la etiqueta #parallel",
  ...
  "fr": {
    ...
    "cfg.enableParallel": "Activer l'exécution parallèle pour les tâches avec #parallel",
  ...
  "de": {
    ...
    "cfg.enableParallel": "Parallele Ausführung für Aufgaben mit dem Tag #parallel aktivieren",
  ...
  "ru": {
    ...
    "cfg.enableParallel": "Разрешить параллельное выполнение для задач с тегом #parallel",
  ...
  "pt-br": {
    ...
    "cfg.enableParallel": "Habilitar execução em paralelo para tarefas com a tag #parallel",
  ...
  "hi": {
    ...
    "cfg.enableParallel": "#parallel टैग वाले कार्यों के लिए समानांतर निष्पादन सक्षम करें",
  ...
  "ar": {
    ...
    "cfg.enableParallel": "تمكين التنفيذ المتوازي للمهام ذات الوسم #parallel",
