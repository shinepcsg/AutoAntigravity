        ...
        try {
            const expr = diagnostic
                ...
                : [
                    ...
                    '    }',
                    '    if (combined.includes("generating")) {',
                    ...
                    '    var l2 = (b2.getAttribute("aria-label") || "").trim();',
                    '    var t2 = (b2.getAttribute("title") || "").trim();',
                    '    var x2 = (b2.textContent || "").trim();',
                    '    if (l2 || t2 || x2) continue;',
                    '    var svg = b2.querySelector("svg");',
                    '    if (!svg) continue;',
